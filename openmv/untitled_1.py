# Untitled - By: Dan Balan - Mon Apr 21 2025
...
class rpc_spi_slave(rpc_slave):
    ...
    def get_bytes(self, buff, timeout_ms):  # protected
        ...
        while self.__pin.value():
            if pyb.elapsed_millis(start) >= self._get_short_timeout_reset:
                return None
...
# SPI Slave interface
interface = rpc_spi_slave(cs_pin="P3", clk_polarity=1, clk_phase=0, spi_bus=2)
